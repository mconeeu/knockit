...
public class MainKitInventory extends CoreInventory {
    ...
    public MainKitInventory() {
        super("§8» §e§lHändler §8| §fKits / Gadgets", InventorySlot.ROW_3, CoreInventory.Option.FILL_EMPTY_SLOTS);
    }
